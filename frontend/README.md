...
CoreUI React Data GridPerson handles 100,000+ rows with sorting, filtering, virtualization, column pinning, inline editing and CSV export — using the same markup and stylesheet this template already uses.
...
- [React Data GridPerson](https://coreui.io/data-grid/react/?src=readme-free-react)
